...
insert into Role(name,role_id) values ('основатель',1), ('вокалист',2), ('бэк-вокалист',3), ('автор песен',4), ('гитарист',5), ('басист',6), ('ударник',7);

insert into Place(country, addr,place_id) values ('USA', 'Aberdeen,  Washington',1), ('USA', 'Springfield,  Virginia',2), ('USA', 'Compton,  California',3), ('USA', 'Seattle,  Washington',4);

insert into Person(name, birth_date, birth_place, death_date,  death_place, sex,person_id) values  ('Dale Crover',  '1967-10-23', 1 , null, null, 'm',1), ('Dave Grohl',  '1969-06-14', 2, null, null, 'm',2), ('Krist Novoselic',  '1965-05-16', 3, null, null, 'm',3), ('Kurt Donald Cobain',  '1967-02-20', 3, '1994-04-05', 4, 'm',4);

insert into Alias (person_id,alias) values ((select person_id from Person where name='Dave Grohl'),'Dale Nixon');

insert into Band (name, formation_date, formation_place, disband_date,band_id) values ('Nirvana', '1987-01-01', (select place_id from Place where country='USA' and addr like 'Aberdeen%'), '1994-01-01',1);
...
Insert into Style(name,style_id) values ('grunge',1),('alternative rock',2);
...
insert into Style(name) values('Trip Hop'),('Steel Band'),('Bayou Funk'),('Cumbia'),('Pop Punk'),('Philippine Classical'),('Folk'),('Europop'),('Norteño'),('Interview'),('Romani'),('Surf'),('Boogie'),('New Beat'),('Dialogue'),('Freestyle'),('Jazz-Rock'),('Guaguancó'),('Thrash'),('Story'),('Bubblegum'),('Mbalax'),('Bass Music'),('Garage House'),('Death Metal'),('Kaseko'),('Radioplay'),('&'),('Juke'),('Celtic'),('Gothic Metal'),('Technical'),('Jungle'),('Beguine'),('Son Montuno'),('Political'),('Darkwave'),('Contemporary Jazz'),('B'),('Garage Rock'),('Swingbeat'),('Black Metal'),('Twelve-tone'),('New Jack Swing'),('Acid Jazz'),('Bounce'),('Post-Hardcore'),('Lao Music'),('Chinese Classical'),('Melodic Death Metal'),('Breaks'),('Indie Rock'),('Bubbling'),('Medieval'),('Ambient'),('Reggae'),('Mariachi'),('Rhythmic Noise'),('Samba'),('Zouk'),('Raï'),('Smooth Jazz'),('No Wave'),('Hard Trance'),('Ranchera'),('Harsh Noise Wall'),('Phleng Phuea Chiwit'),('Thai Classical'),('Jazzdance'),('Pachanga'),('Bollywood'),('Cha-Cha'),('Catalan Music'),('Rumba'),('Mugham'),('Texas Blues'),('Cajun'),('Viking Metal'),('Acid Rock'),('Rebetiko'),('Funk / Soul'),('Indian Classical'),('Roots Reggae'),('Hiplife'),('Modern Electric Blues'),('Experimental'),('Emo'),('Jibaro'),('Forro'),('Ballad'),('Tribal House'),('Miami Bass'),('Early'),('Éntekhno'),('Roll'),('Progressive Metal'),('Jazz-Funk'),('Hardstyle'),('Acid'),('Sound Art'),('Industrial'),('Sephardic'),('Highlife'),('Operetta'),('Acid House'),('Reggae-Pop'),('Dungeon Synth'),('Vallenato'),('Polka'),('Power Electronics'),('Zydeco'),('Country Blues'),('Guarania'),('Tango'),('Goregrind'),('Favela Funk'),('Ska'),('Blues'),('Folk Metal'),('Romantic'),('Drum n Bass'),('Screw'),('Boogaloo'),('Ghetto'),('Dub Techno'),('Italo-Disco'),('Disco Polo'),('Korean Court Music'),('Sound Collage'),('Piano Blues'),('Drone'),('Canzone Napoletana'),('Flamenco'),('Gagaku'),('Impressionist'),('Nueva Trova'),('Dance-pop'),('Persian Classical'),('Symphonic Rock'),('Tech Trance'),('Cubano'),('Junkanoo'),('Forró'),('Trance'),('Carnatic'),('Conscious'),('Audiobook'),('Lo-Fi'),('Luk Krung'),('Eurodance'),('Laïkó'),('UK Garage'),('Baroque'),('Ghetto House'),('Sonero'),('Non-Music'),('Prog Rock'),('Crust'),('Afro-Cuban'),('Western Swing'),('Soukous'),('Neofolk'),('Happy Hardcore'),('Vaporwave'),('DJ Battle Tool'),('Indie Pop'),('Lounge'),('Dixieland'),('Music Hall'),('Instrumental'),('Avant-garde Jazz'),('Chiptune'),('Nursery Rhymes'),('Rhythm'),('Bluegrass'),('Educational'),('Hands Up'),('Krautrock'),('Serial'),('Son'),('Overtone Singing'),('Pacific'),('Theme'),('Nu-Disco'),('Bassline'),('Swamp Pop'),('Downtempo'),('Grindcore'),('Monolog'),('Bolero'),('Bachata'),('Reggae Gospel'),('Deep Techno'),('Education'),('Dub Poetry'),('Chicago Blues'),('Ghettotech'),('Skiffle'),('Bop'),('Shoegaze'),('Klezmer'),('Acoustic'),('Plena'),('Post Rock'),('Sermon'),('Schranz'),('Cuatro'),('Nu Metal'),('Big Band'),('Volksmusik'),('Berlin-School'),('Broken Beat'),('Field Recording'),('Louisiana Blues'),('Bongo Flava'),('Thug Rap'),('Rockabilly'),('Art Rock'),('Power Pop'),('Nitzhonot'),('Dub'),('Baltimore Club'),('Speedcore'),('Doomcore'),('Stoner Rock'),('Bossanova'),('Skweee'),('Bangladeshi Classical'),('Hip Hop'),('Math Rock'),('Hardcore'),('AOR'),('Crunk'),('Pipe'),('Funk Metal'),('Quechua'),('RnB/Swing'),('Soft Rock'),('Boogie Woogie'),('Neo-Classical'),('Jazzy Hip-Hop'),('Religious'),('Mizrahi'),('Oi'),('Free Jazz'),('Free Improvisation'),('Contemporary R'),('Space-Age'),('Luk Thung'),('Lovers Rock'),('Eurobeat'),('Neo-Romantic'),('Neo Trance'),('Folk, World,'),('Pop Rap'),('Boom Bap'),('Psychedelic Rock'),('Hillbilly'),('Psychedelic'),('Free Funk'),('Andalusian Classical'),('Swing'),('Aboriginal'),('Stage'),('Ottoman Classical'),('Comedy'),('Avantgarde'),('Cambodian Classical'),('Glitch'),('Brit Pop'),('Tropical House'),('Hardcore Hip-Hop'),('Pop'),('Light Music'),('Soundtrack'),('Salsa'),('Soul'),('Hard House'),('Coldwave'),('Rune Singing'),('Fusion'),('Copla'),('Brass Band'),('Hindustani'),('Gabber'),('Guajira'),('Arena Rock'),('Dancehall'),('Tejano'),('Pub Rock'),('Military'),('Sound Poetry'),('Ragga'),('Schlager'),('J-pop'),('Timba'),('Jump Blues'),('Tech House'),('Synth-pop'),('Chamamé'),('Renaissance'),('Dubstep'),('Lambada'),('Séga'),('Goa Trance'),('Synthwave'),('Witch House'),('Guaracha'),('Descarga'),('Therapy'),('Punk'),('Noise'),('Cloud Rap'),('Melodic Hardcore'),('Alternative Rock'),('Folk Rock'),('Psy-Trance'),('Fado'),('Spoken Word'),('Modern'),('Gangsta'),('IDM'),('Horrorcore'),('Leftfield'),('Deathrock'),('Kwaito'),('Cut-up/DJ'),('Italo House'),('Hyphy'),('Post Bop'),('Italodance'),('Soul-Jazz'),('Breakcore'),('Karaoke'),('Rapso'),('Public Broadcast'),('Modern Classical'),('Score'),('Disco'),('Honky Tonk'),('Latin'),('Blues Rock'),('East Coast Blues'),('Dark Ambient'),('Vocal'),('Electric Blues'),('Bhangra'),('Minneapolis Sound'),('Ballroom'),('Grime'),('Funk'),('Cape Jazz'),('Post-Modern'),('Mento'),('Mod'),('P.Funk'),('Deathcore'),('Ethereal'),('Heavy Metal'),('Jazz'),('Psychobilly'),('Goth Rock'),('Speech'),('Classical'),('Modal'),('Delta Blues'),('MPB'),('Progressive House'),('Compas'),('Electro House'),('Doom Metal'),('Children s'),('Musique Concrète'),('Poetry'),('Space Rock'),('New Age'),('Trova'),('Turntablism'),('House'),('Marches'),('Porro'),('Mambo'),('Minimal'),('Pop Rock'),('Hi NRG'),('Parody'),('Deep House'),('Népzene'),('Memphis Blues'),('Big Beat'),('Country'),('Sludge Metal'),('Sámi Music'),('Opera'),('Griot'),('Future Jazz'),('Jumpstyle'),('Breakbeat'),('Afrobeat'),('Piobaireachd'),('Special Effects'),('Nordic'),('Charanga'),('Corrido'),('EBM'),('Easy Listening'),('Hard Beat'),('Danzon'),('Latin Jazz'),('Illbient'),('Metalcore'),('Abstract'),('Grunge'),('Power Metal'),('Electronic'),('Electroclash'),('Trap'),('Hip-House'),('Tribal'),('Spaza'),('Speed Garage'),('G-Funk'),('Axé'),('Afro-Cuban Jazz'),('Beatbox'),('Joropo'),('Country Rock'),('Neo Soul'),('Euro-Disco'),('Beatdown'),('J-Core'),('Southern Rock'),('Rocksteady'),('Donk'),('Classic Rock'),('Post-Punk'),('Harmonica Blues'),('Calypso'),('Promotional'),('Progressive Trance'),('Nueva Cancion'),('Piedmont Blues'),('Conjunto'),('Musical'),('Marimba'),('Sea Shanties'),('Novelty'),('Batucada'),('Rock'),('Chanson'),('Hard Bop'),('Contemporary'),('Makina'),('Keroncong'),('Merengue'),('Reggaeton'),('Gospel'),('Min yō'),('Speed Metal'),('Chillwave'),('Cool Jazz'),('Doo Wop'),('Mouth Music'),('Screen'),('Brass'),('Beat'),('Kayōkyoku'),('Klasik'),('Glam'),('Gogo'),('Minimal Techno'),('New Wave'),('Movie Effects'),('Progressive Breaks'),('Gamelan'),('Euro House'),('Hard Rock'),('Hard Techno'),('Techno'),('Ragtime'),('Bossa Nova'),('Drum'),('Britcore'),('Public Service Announcement'),('African'),('Gypsy Jazz'),('Go-Go'),('Electro'),('Ragga HipHop'),('Soca'),('Enka');
